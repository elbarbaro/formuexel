...
function InputDropArea(props) {
    ...
    return (
        <div className="InputDropArea h-64 p-2 bg-indigo-200 hover:bg-indigo-300 overflow-y-auto" onDragEnter={onDragEnter} onDrop={onDrop} onDragOver={onDragOver} onDragLeave={onDragLeave}>
